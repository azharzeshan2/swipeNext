        ...
        <footer class="bg-blue-100">
            <div className="container pt-12 mx-auto pb-10 px-8 sm:px-0 flex items-start md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                <div className="flex-2">
                    ...
                    <p className="max-w-sm mt-2 font-jost text-lg text-black text-center md:text-base xl:text-lg lg:text-lg md:pr-8 sm:text-left">Swipe Your Bite bundelt de lekkerste vega recepten van het web in één app. Swipe en creëer je persoonlijke receptenboek.</p>
                ...
                <div className="flex-1 md:-ml-16 xl:md-0 lg:ml-0 xl:mt-0 lg:mt-0 md:-mt-20">
                     <h2 class="font-jost font-semibold text-xl mb-5 md:text-lg xl:text-xl lg:text-xl ">Contact</h2>
                     <div class="flex flex-row items-center my-2"><img src="/email.png" alt="email-icon" class="object-contain mr-2" /><a href="mailto:info@swipeyourbite.nl"><p className="my-auto md:text-sm md:mr-8  xl:text-xl lg:text-xl">info@swipeyourbite.nl</p></a></div>
                     <div class="flex flex-row my-2"><img src="/phone.png" alt="email-icon" class="object-contain mr-2" /><a href="tel:06-83 56 28 69"><p className="md:text-sm xl:text-xl lg:text-xl md:mr-8">06-83 56 28 69</p></a></div>
                     </div>
                     <div class="flex-1 xl:mt-0 lg:mt-0 md:-mt-8 mb-4">
                         <h2 class="font-jost font-semibold text-xl mb-5 md:text-base xl:text-xl lg:text-xl">Links</h2>
